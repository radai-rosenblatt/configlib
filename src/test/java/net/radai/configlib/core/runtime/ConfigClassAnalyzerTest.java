 ...
 */
public class ConfigClassAnalyzerTest {

    @Test
    public void testPropertyResolution() throws Exception {
        Property prop0 = ConfigClassAnalyzer.resolve(TestClass1.class, "prop0");
    ...
    public void testBooleanPropertyResolution() throws Exception {
        Property b1 = ConfigClassAnalyzer.resolve(TestClass2.class, "b1");
        Assert.assertNotNull(b1);
        Assert.assertTrue(b1.isReadable());
        Assert.assertTrue(b1.isWritable());
        Property b2 = ConfigClassAnalyzer.resolve(TestClass2.class, "b2");
        Assert.assertNotNull(b2);
        Assert.assertTrue(b2.isReadable());
        Assert.assertTrue(b2.isWritable());
        Property b3 = ConfigClassAnalyzer.resolve(TestClass2.class, "b3");
        Assert.assertNotNull(b3);
        Assert.assertTrue(b3.isReadable());
        Assert.assertTrue(b3.isWritable());
        Property b4 = ConfigClassAnalyzer.resolve(TestClass2.class, "b4");
    ...
    public void testAnalyze() throws Exception {
        Config desc = ConfigClassAnalyzer.analyze(TestClass3.class);
