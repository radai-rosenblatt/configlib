 ...
 */
public class SimpleInvalidConfigurationEvent<T> implements InvalidConfigurationEvent<T> {
    private final Class<T> confClass;
    private final T conf;
    private final ValidationResults<?> validationResults;

    public SimpleInvalidConfigurationEvent(Class<T> confClass, T conf, ValidationResults<?> validationResults) {
